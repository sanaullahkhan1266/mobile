  ...
  const categories = [
    {
      title: 'Quick Actions',
      items: [
        { title: 'Trade', icon: 'trending-up-outline', route: '/trade' },
    ...
    },
    {
      title: 'Trade Crypto',
      items: [
        { title: 'BTC', icon: 'logo-bitcoin', route: '/trade?symbol=BTC' },
        { title: 'ETH', icon: 'diamond-outline', route: '/trade?symbol=ETH' },
        { title: 'USDT', icon: 'card-outline', route: '/trade?symbol=USDT' },
        { title: 'USDC', icon: 'ellipse-outline', route: '/trade?symbol=USDC' },
        { title: 'BNB', icon: 'triangle-outline', route: '/trade?symbol=BNB' },
        { title: 'SOL', icon: 'sunny-outline', route: '/trade?symbol=SOL' },
        { title: 'TRX', icon: 'flash-outline', route: '/trade?symbol=TRX' },
        { title: 'XRP', icon: 'water-outline', route: '/trade?symbol=XRP' },
      ],
    },
    {
